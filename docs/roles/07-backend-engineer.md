...
**Supabase Client Functions** (`src/lib/supabase.js`)
- All database helper functions
- Authentication helpers
- Data transformation utilities

**Custom Backend** (`backend/`)
- `server.js` - Express server for admin operations
- `authMiddleware.js` - JWT validation
- `uploadCamps.js` - Data import scripts

### Edge Functions (Potential)
For Phase 2 notifications, may need:
- Push notification sender
- Scheduled registration reminders
