...
- Phase 4: Marketplace & Advanced

### Key Milestones
- Summer 2026 registration season (Jan-Mar 2026) - critical deadline
- Camp season (Jun-Aug 2026) - feature usage peak

### Resource Considerations
- Single developer (Claude) acting across multiple roles
- User as primary stakeholder and product owner
- Supabase + Vercel infrastructure constraints

### Output Location
- Project plans in `docs/project/`
- Sprint tracking in GitHub Issues or similar
