...
### Key Stakeholders
- Primary: Parents (mothers managing 71% of household scheduling)
- Secondary: Working parents needing full coverage
- Tertiary: Camp owners/administrators

### Domain Knowledge Required
- Summer camp registration processes and timelines
- Santa Barbara local camp landscape
- Parent scheduling pain points and workflows
- FSA/dependent care account requirements

### Existing Research Artifacts
- [PRODUCT_PLAN.md](../PRODUCT_PLAN.md) - User research synthesis and pain points
- Competitive analysis (CampMinder, UltraCamp, generic calendars)
- User personas documented in product plan

### Output Location
- BRDs go in `docs/requirements/`
- User stories go in project management tool or `docs/stories/`
