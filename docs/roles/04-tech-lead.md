...
1. Supabase for backend (vs custom API)
2. Client-side state management (vs Redux/Zustand)
3. Single-page application (vs SSR/Next.js)
4. Tailwind CSS (vs CSS modules/styled-components)

### Performance Considerations
- Current bundle: 705KB (needs code splitting)
