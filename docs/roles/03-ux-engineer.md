...
Reference [CLAUDE.md](../../CLAUDE.md) for brand voice:
- **Tone**: Direct, confident, efficient
- **Avoid**: Exclamation points, mommy-blog speak, patronizing language
...
### Key User Flows
1. Camp Discovery → Filter → Compare → Save
2. Schedule Planning → Drag-drop → Preview → Commit
3. Registration Tracking → Alerts → External link
